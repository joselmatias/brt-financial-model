...
# ---------- TRONCAL 3 – Parámetros por defecto ----------
TRONCAL_3_DEFAULT = {
    # --- Identificación ---
    "nombre": "Troncal 3",
    ...
    "base_demanda": {
        "ESTUDIANTES":             696_614,
        "ADULTOS MAYORES":       1_042_807,
        "CAPACIDADES ESPECIALES":  532_097,
        "GENERAL":              22_309_741,
    },
    ...
    # Troncal (buses 18 m – igual que T1)
    "km_totales_troncal": 1_045_800,
    "costo_km_troncal":        0.33,
    "unidades_troncal":          42,

    # Alimentación (buses 12 m)
    "km_totales_alim_12y": 667_800,
    "costo_km_alim":            0.22,
    "unidades_alim":              32,
    ...
    # --- Equity: incluye AMBAS flotas (igual que Troncal 2) ---
    "equity_incluye_troncal": True,
}

# ---------- TRONCAL 4 – Parámetros por defecto ----------
TRONCAL_4_DEFAULT = {
    # --- Identificación ---
    "nombre": "Troncal 4",
    ...
    "base_demanda": {
        "ESTUDIANTES":             835_237,
        "ADULTOS MAYORES":       1_250_322,
        "CAPACIDADES ESPECIALES":  589_104,
        "GENERAL":              26_398_306,
    },
    ...
    # Troncal (buses 12 m – precio igual al alimentador)
    "km_totales_troncal": 879_780,
    "costo_km_troncal":      0.22,
    "unidades_troncal":        58,

    # Alimentación (buses 12 m)
    "km_totales_alim_12y": 804_000,
    "costo_km_alim":            0.22,
    "unidades_alim":              62,
    ...
    "precio_galon":            2.80,
    "rend_km_gal_alim":        5.76,   # km/gal buses 12 m
    "rend_km_gal_troncal":     5.76,   # km/gal buses 12 m
    "combustible_aplica_prorrateo": False,
    ...
    # --- Costos Fijos: Financiamiento ---
    # Ambas flotas usan buses 12 m → mismo precio unitario
    "precio_bus_troncal":       156_848.0,
    "precio_bus_alimentador":   156_848.0,
    "tasa_interes_anual":          0.0948,
    "plazo_anios_financ":               7,
    "porcentaje_financiado":         0.80,
...
TRONCALES = {
    ...
    "Troncal 3": TRONCAL_3_DEFAULT,
    "Troncal 4": TRONCAL_4_DEFAULT,
}
